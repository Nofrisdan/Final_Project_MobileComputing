...
public class EnternainmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enternainment);

        news = findViewById(R.id.news);
        api = Server.getApiService();
        adapter = new NewsAdapter(EnternainmentActivity.this, list);

        news.setHasFixedSize(true);
        news.setLayoutManager(new LinearLayoutManager(EnternainmentActivity.this));
    ...
    public void refresh() {
        loading = new ProgressDialog(EnternainmentActivity.this);
        ...
        api.getListNews("id", category, BuildConfig.NEWS_API_TOKEN).enqueue(new Callback<ResponseNews>() {
            ...
            public void onResponse(Call<ResponseNews> call, Response<ResponseNews> response) {
                if (response.isSuccessful()){
                    ...
                    news.setAdapter(new NewsAdapter(EnternainmentActivity.this, list));
                    adapter.notifyDataSetChanged();
                } else {
                    hideDialog();
                    Toast.makeText(EnternainmentActivity.this, "Gagal mengambil data !", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<ResponseNews> call, Throwable t) {
                hideDialog();
                Toast.makeText(EnternainmentActivity.this, "Gagal menyambung ke internet !", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public boolean onSupportNavigateUp() {
        Intent intent = new Intent(EnternainmentActivity.this, MainActivity.class);
